...
Future getCategoryCreation(BuildContext context) {
  List<String> myCategoriesIcons = [
    'assets/clothes-hanger.svg',
    'assets/dish.svg',
    'assets/jewelry.svg',
    'assets/plug.svg',
    'assets/skincare.svg',
    'assets/smart-car.svg',
    'assets/travel.svg',
    'assets/water-tap.svg',
  ];
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          border: Border.all(width: 3, color: iconSelected == myCategoriesIcons[i] ? Colors.green : Colors.grey), borderRadius: BorderRadius.circular(12),
                                         ),
                                        // image: DecorationImage(image: AssetImage('assets/${myCategoriesIcons[i]}.png'))
                                        child: SvgPicture.asset(myCategoriesIcons[i]),
                                    ),
                                  );
                                }
                            ),
                            ...
                            child: CircularProgressIndicator(),
                              ...
                              onPressed: () {
                                ...
                                if(category.name != '' && category.icon != '' && category.color != ''){
                                  ...
                                  BotToast.showSimpleNotification(title: "Please enter the form");
                                }
