...
import 'package:expense_tracker/screen/add_expense/view/category_creation.dart';
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: expense.category == Category.empty
                              ...
                              color: Colors.grey,
                                ...
                                : SvgPicture.asset(expense.category.icon,
                              height: 0,
                            ),
                            // Image.asset(
                                  ...
                                  itemBuilder: (context, int i) {
                                    return Card(
                                      child: ListTile(
                                        ...
                                        leading: SvgPicture.asset(state.categories[i].icon,
                                          height: 30,
                                        ),
